...
$l['mybb_incorrect_folder'] = "<div class=\"border_wrapper upgrade_note\" style=\"padding: 4px;\">
	...
	<p>当然，这样并没有错，但是我们强烈建议您重命名 \"Upload\" 目录。<br /><br /></p>
</div>";
...
$l['req_step_error_phpversion'] = 'MyBB 需要 PHP 5.2.0 或以上版本，您的当前版本为 {1} ';
...
$l['req_step_error_configdefaultfile'] = '配置文件 (inc/config.default.php) 无法重命名。请手动将 <u>config.default.php</u> 文件重命名为 <u>config.php</u> 并设置权限为可写或者联系 <a href="http://www.mybb.com/support" target="_blank">MyBB Support.</a>';
$l['req_step_error_configfile'] = '配置文件 (inc/config.php) 不可写。请使用chmod更改权限为可写。';
$l['req_step_error_settingsfile'] = '设置文件 (inc/settings.php) 不可写。请使用chmod更改权限为可写。';
$l['req_step_error_cachedir'] = '缓存目录 (cache/) 不可写。请使用chmod更改权限为可写。';
$l['req_step_error_uploaddir'] = '上传目录 (uploads/) 不可写。请使用chmod更改权限为可写。';
$l['req_step_error_avatardir'] = '头像目录 (uploads/avatars/) 不可写。请使用chmod更改权限为可写。';
$l['req_step_error_cssddir'] = 'The css directory (css/) 不可写。请使用chmod更改权限为可写。';
...
$l['db_step_error_utf8mb4_error'] = '\'4-Byte UTF-8 Unicode\' 需要MySQL 5.5.3 或以上版本，请选择一个适合您MySQL版本的编码';
...
<tr>
<th colspan="2" class="first last">Cookie设置 <a title="What\'s this?" target="_blank" href="http://docs.mybb.com/Cookie_Settings.html">(?)</a></th>
</tr>
<tr>
...
<tr class="last">
<td class="first"><label for="contactemail">联系 Email:</label></td>
<td class="last alt_col"><input type="text" class="text_input" name="contactemail" id="contactemail" value="{7}" /></td>
</tr>
<tr>
<th colspan="2" class="first last">安全设置</th>
</tr>
<tr class="last">
<td class="first"><label for="acppin">管理面板 PIN:</label><br />如果您不想设置此处请留空</td>
...
$l['config_step_revert'] = '点击以恢复设定至初始值';
...
<tr class="first last">
<td class="first"><label for="adminemail">Email 地址：</label></td>
...
$l['admin_step_nomatch'] = '输入的两次密码不一致，请修改以继续';
...
$l['done_whats_next'] = '<div class="error"><p><strong>从另一个论坛系统转过来的?</strong></p><p>MyBB提供了一个合并系统，可以轻易地将多种热门论坛程序转换到MyBB，如果您正在尝试转到MyBB，请查看<a target="_blank" href="http://www.mybb.com/downloads/merge-system">Merge System</a> 以获取更多内容</p>';
...
$l['upgrade_congrats'] = "<p>祝贺，已成功更新至 {1}。</p><p><strong><span style=\"color:red\">强烈建议访问论坛前删除此安装目录 'install'</span></strong></p>{2}<p><strong>接下来干什么？</strong></p><ul><li>请在管理员控制面板中使用 '查找更新过的模板' 工具找到在这个升级过程中更新的自定义模板。重新编辑改动过的地方或者还原为默认模板。</li><li>确保您的论坛功能完整。</li></ul>";
...
$l['please_login'] = "请登录";
$l['login'] = "登录";
$l['login_desc'] = "请输入您的用户名和密码开始升级，您必须拥有管理权限以执行此操作";
$l['login_username'] = "用户名";
$l['login_password'] = "密码";
$l['login_password_desc'] = "请注意密码是区分大小写的。";

/* Error messages */
$l['development_preview'] = "<div class=\"error\"><h2 class=\"fail\">警告</h2><p>当前使用的MyBB版本为开发预览版，仅供测试使用。</p><p>此版本的插件和主题开发将不提供官方支持，继续安装/升级此版本所带来的风险由您自己承担</p></div>";
$l['locked'] = '安装程序目前被锁住，请从安装目录删除 \'lock\' 文件以便继续。';
$l['no_permision'] = "您没有权限执行此操作，需要管理员权限。<br /><br />如果您需要登出，请点击 <a href=\"upgrade.php?action=logout&amp;logoutkey={1}\">这里</a>，然后以管理员用户登录并再次尝试。";
