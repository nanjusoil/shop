...
$l['ban_an_ip_address'] = "禁止一个IP地址";
$l['ip_address_desc'] = "注意：要禁止一个IP地址范围请使用 *（Ex: 127.0.0.*）或CIDR标记(Ex: 127.0.0.0/8)";
$l['ban_ip_address'] = "禁用一个IP地址";

$l['error_missing_ban_input'] = "您没有为这个禁止规则指定一个值。";
$l['error_invalid_filter'] = "指定的过滤器不存在。";
$l['error_filter_already_banned'] = "您输入的过滤器已被禁用";
