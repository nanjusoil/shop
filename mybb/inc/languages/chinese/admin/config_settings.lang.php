...
$l['forum_selection_box'] = "论坛选择框";
$l['group_selection_box'] = "组选择框";
...
$l['error_chmod_settings_file'] = "设置文件 \"./inc/settings.php\" 不可写. 请将其 CHMOD 到 777.<br />更多关于CHMOD的信息见 <a href=\"http://docs.mybb.com/HowTo_Chmod.html\" target=\"_blank\">MyBB文档</a>.";
$l['error_hidden_captcha_conflict'] = "隐藏验证码的值不能为\"{1}\",这会与注册表单中的另一个字段冲突";
