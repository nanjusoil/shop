...
$l['backups'] = "备份";
$l['existing_database_backups'] = "已存在的数据库备份文件";

$l['backup_saved_to'] = "备份文件存放在:";
$l['download'] = "下载到本地";
$l['table_selection'] = "选择数据表";
$l['backup_options'] = "备份选项";
$l['table_select_desc'] = "在这里您可以选择要执行这个操作的数据表。按住CTRL键选择多个表格。";
$l['select_all'] = "全选";
$l['deselect_all'] = "取消全选";
$l['select_forum_tables'] = "选择论坛相关数据表";
$l['file_type'] = "文件类型";
$l['file_type_desc'] = "选择数据库备份的文件类型。";
$l['gzip_compressed'] = "GZIP压缩";
$l['plain_text'] = "文本";
$l['save_method'] = "保存方式";
$l['save_method_desc'] = "选择保存备份数据库文件的方式";
$l['backup_directory'] = "保存在备份目录";
$l['backup_contents'] = "备份内容";
$l['backup_contents_desc'] = "选择您想要备份的内容。";
$l['structure_and_data'] = "结构和数据";
$l['structure_only'] = "结构";
$l['data_only'] = "数据";
$l['analyze_and_optimize'] = "分析并优化选择的表";
$l['analyze_and_optimize_desc'] = "是否在备份过程中分析并优化选定的表？";
