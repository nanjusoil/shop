...
$l['manage_users'] = "管理用户";
$l['manage_users_desc'] = "批量管理用户变得更加简单。";
$l['inline_edit'] = "内置用户管理:";
$l['inline_activate'] = "激活用户";
$l['inline_ban'] = "封禁用户";
$l['inline_usergroup'] = "改变用户所属的用户组";
$l['inline_delete'] = "删除用户";
$l['inline_prune'] = "修剪/删除 用户的帖子";
$l['inline_activated'] = "{1} 个用户激活成功。";
$l['inline_activated_more'] = "<small>您选择的 {1} 个用户已经成功激活。</small>";
$l['inline_activated_failed'] = "选择的用户已经是激活的了。";
$l['ban_time'] = "封禁时长 <em>*</em>";
$l['ban_reason'] = "封号原因";
$l['mass_ban'] = "批量封禁用户";
$l['important'] = "重要";
$l['mass_ban_info'] = "此操作将影响 {1} 个用户。如果确定请继续。";
$l['ban_users'] = "封禁用户";
$l['users_banned'] = "{1} 个用户已经被封禁。";
$l['confirm_multilift'] = "确定要取消所选择用户的封禁?";
$l['success_ban_lifted'] = "{1} 个用户已经取消封禁。";
$l['edit_ban'] = "编辑禁令";
$l['lift_ban'] = "解除禁令";
$l['lift_bans'] = "取消封禁";
$l['confirm_multidelete'] = "确定要删除这 {1} 个用户? 此操作无法恢复。";
$l['users_deleted'] = "{1} 个用户已经被删除。";
$l['mass_prune_info'] = "这个操作将会影响 {1} 个用户。如果继续，将会移除下面输入的日期之前用户发布的所有帖子。<br /><br /><strong>请注意，如果用户的帖子是某个主题的第一个帖子，那么这个主题将被移除。</strong>";
$l['mass_prune_posts'] = "批量修剪帖子";
$l['manual_date'] = "手动输入日期";
$l['relative_date'] = "或者选择一个删除选项";
$l['multi_selected_dates'] = "你已经同时选则了手动输入日期和设置选项。请只选择其中的一个。";
$l['incorrect_date'] = "输入的日期无效。请输入一个有效的日期，或者留空并选择一个设置选项。";
$l['prune_complete'] = "修剪成功。";
$l['prune_fail'] = "没有找到选定用户的帖子。没有帖子被修剪。";
$l['no_prune_option'] = "请输入日期或者选择一个选项以继续。";
$l['prune_posts'] = "修剪帖子";
$l['delete_posts'] = "删除帖子";
$l['usergroup_info'] = "接下来的操作将影响 {1} 个用户。选择下面的选项，将覆盖选则的用户的 主/附加/显示 用户组。";
$l['mass_usergroups'] = "批量改变用户组";
$l['success_mass_usergroups'] = "用户更新成功。";
$l['alter_usergroups'] = "保存更改";
$l['no_usergroup_changed'] = "你选择的用户没有改变用户组。";
$l['no_set_option'] = "没有选择有效的设置日期。请从下拉列表选择或者手动输入日期。";
$l['select_an_option'] = "(选择一个选项)";
...
$l['error_invalidavatarurl'] = "您输入的头像网址 似乎不是一个有效的地址, 请确认输入一个有效的网址。";
...
$l['error_cannot_delete_view'] = "至少要有1个管理员的快速查看。";
$l['error_inline_no_users_selected'] = "抱歉，你没有选择任何用户。请选择一些用户在试一次。";
$l['error_cannot_delete_user'] = "此用户无法被删除";
$l['error_no_referred_users'] = "选择的用户没有任何推介用户";
...
$l['skype_handle'] = "Skype处理";
$l['google_handle'] = "Google Talk 处理";
$l['birthday'] = "出生日期";

$l['away_information'] = "离开消息";
$l['away_status'] = "离开状态:";
$l['away_status_desc'] = "如果您要暂时离开可以设置留言。";
$l['im_away'] = "我不在";
$l['im_here'] = "我在线";
$l['away_reason'] = "离开原因:";
...
$l['error_acp_return_date_past'] = "您不能把回来时间设为过去!";
...
$l['automatically_detect'] = "自动检测 DST 设定";
$l['always_use_dst_correction'] = "总是使用 DST 修正";
$l['never_use_dst_correction'] = "从不使用 DST 修正";
...
$l['show_threads_last_year'] = "最近一年以来的主题";
$l['show_all_threads'] = "全部帖子";
$l['threads_per_page'] = "每页主题数";
$l['default_thread_age_view'] = "默认主题查看";
$l['forum_display_options'] = "论坛显示选项";
$l['show_classic_postbit'] = "以传统模式显示贴子";
$l['display_images'] = "在帖子中显示图片";
$l['display_videos'] = "在帖子中显示视频";
...
$l['suspend_sig'] = "挂起签名";
$l['suspend_sig_box'] = "刮起该用户的签名";
$l['suspend_sig_perm'] = "<small>永久挂起。</small>";
$l['suspend_sig_info'] = "如果签名被挂起，用户就无法编辑，也不会在个人资料或者发布的帖子中显示。";
$l['suspend_sig_extend'] = "<small>在下面输入一个新的时间来改变，或者取消勾选这个选项来移除挂起。</small>";
$l['suspend_expire_info'] = "<small>过期 {1}</small>";
$l['suspend_never_expire'] = "<small>{1} 的挂起将永不过期 (永久挂起)。</small>";
$l['suspend_sig_error'] = "时间不正确，请输入正确的时间。";

$l['moderate_posts'] = "处理帖子";
$l['moderate_posts_info'] = "处理新帖由 {1}.";
$l['moderate_for'] = "处理:";
$l['moderated_perm'] = "<p><small>永久处理。<br />在下面输入一个新时间来改变或者取消选择该选项以移除这个处理。</small></p>";
$l['moderate_length'] = "<p><small>处理直到 {1}.<br />在下面输入一个新时间来改变或者取消选择该选项以移除这个处理。</small></p>";

$l['suspend_posts'] = "挂起帖子";
$l['suspend_posts_info'] = "挂起 {1} 从标记新帖。";
$l['suspend_for'] = "暂停:";
$l['suspended_perm'] = "<p><small>永久挂起。<br />在下面输入一个新时间来改变或者取消选择该选项以移除这个挂起。</small></p>";
$l['suspend_length'] = "<p><small>挂起直到 {1}.<br />在下面输入一个新时间来改变或者取消选择该选项以移除这个挂起。</small></p>";
...
$l['suspendmoderate_error'] = "您同时选择了暂停和处理用户的帖子。请只选择其中的一个。";

$l['expire_length'] = "暂停时长:";
$l['expire_hours'] = "小时";
$l['expire_days'] = "天";
$l['expire_weeks'] = "周";
$l['expire_months'] = "月";
...
$l['or_specify_avatar_url'] = "或指定Avatar/Gravatar URL";
...
$l['skype_contains'] = "Skype包括";
$l['google_contains'] = "Google Talk包括";
...
$l['thread_count_is'] = "主题数是";
$l['reg_ip_matches'] = "注册IP地址";
$l['wildcard'] = "搜索一个IP地址范围请使用*（Ex: 127.0.0.*）或CIDR标记(Ex: 127.0.0.0/8)";
$l['posted_with_ip'] = "发帖IP地址";
$l['custom_profile_fields_match'] = "匹配自定义个人资料字段...";
$l['is_not_blank'] = "不为空";
$l['or'] = "或者";
$l['reg_in_x_days'] = "最后注册的";
$l['days'] = "天";
...
管理员已于 {2}.激活了您的帐户 点击查看{3} 您可以使用注册的用户名和密码 感谢您的使用 {2} 工作人员";
