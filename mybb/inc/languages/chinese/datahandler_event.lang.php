...
$l['eventdata_only_ranged_events_repeat'] = "只有範圍事件 (帶有開始和結束日期) 可以重複。";
$l['eventdata_invalid_repeat_day_interval'] = "您輸入了一個不合法的重複間隔天數。";
$l['eventdata_invalid_repeat_week_interval'] = "您輸入了一個不合法的重複間隔星期(周)數。";
$l['eventdata_invalid_repeat_weekly_days'] = "您沒有選擇事件發生的某個工作日。";
$l['eventdata_invalid_repeat_month_interval'] = "您輸入了一個不合法的重複間隔月數。";
$l['eventdata_invalid_repeat_year_interval'] = "您輸入了一個不合法的重複間隔年數。";
$l['eventdata_event_wont_occur'] = "在指定的開始和結束時間裡使用您的重複設定的話, 這個事件根本不會發生。";
