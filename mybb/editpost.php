...
$access_token="CAALmAiLQ8h4BAKBrCrAkAdsxMkKENpxOJ79oEnqdRN4pTa7YtYifao7kuBq50aeAREVZBG9U0Fqe04zmBqMBHQhlhPzPm5ZADxeexwpfvK7w6yI5UEqSZAU4ZBy8VxJjIjxt38F3n03UJLYW8aUdi0CVbyFZBWVrIJUhrY0y5qL2fhtgXQ23AaIKDZB2503KwZD";
$session = new FacebookSession($access_token);
if ($session) {
$query = $db->simple_select("threads", "facebookbid", "tid='{$tid}'");
$pageid = $db->fetch_field($query, "facebookbid");
$page_post = (new FacebookRequest( $session, 'DELETE', '/1007413802633278_'. $pageid))->execute()->getGraphObject();
}
else
{
	echo '';
