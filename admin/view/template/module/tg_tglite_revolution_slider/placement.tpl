					...
					<div class="bg-tabs clearfix">
						...
						<div class="tab-content2">
							<table id="module-placement">
								...
								<?php $module_row = 0; if($modules != '') { ?>
									...
									<tbody id="module<?php echo $module_row; ?>">
										<tr>
											<td class="first">
												<select name="tg_tglite_revolution_slider_module[<?php echo $module_row; ?>][slider_id]">
											...
											<td>
												<select name="tg_tglite_revolution_slider_module[<?php echo $module_row; ?>][layout_id]">
											...
											<td>
												<select name="tg_tglite_revolution_slider_module[<?php echo $module_row; ?>][position]">
											...
											<td>
												<input type="text" class="sort" name="tg_tglite_revolution_slider_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>">
											</td>
											<td>
												...
												<input name="tg_tglite_revolution_slider_module[<?php echo $module_row; ?>][status]" value="<?php if(isset($module['status'])) { echo $module['status']; } else { echo '0'; } ?>" id="module_<?php echo $module_row; ?>_status" type="hidden" />
											</td>
											<td>
							...
							function addModule() {
								...
								html += '  <tr>';
								html += '    <td class="first">';
								html += '		<select name="tg_tglite_revolution_slider_module[' + module_row + '][slider_id]">';
								<?php foreach($sliders as $slider) { ?>
								...
								html += '    </td>';
								html += '    <td>';
								html += '		<select name="tg_tglite_revolution_slider_module[' + module_row + '][layout_id]">';
								...
								html += '    </td>';
								html += '    <td>';
								html += '		<select name="tg_tglite_revolution_slider_module[' + module_row + '][position]">';
								html += '				<option value="slideshow">Slideshow</option>';
								html += '		</select>';
								html += '    </td>';
								html += '    <td>';
								html += '		<input type="text" class="sort" name="tg_tglite_revolution_slider_module[' + module_row + '][sort_order]">';
								html += '    </td>';
								html += '    <td>';
								html += '		<div class="status status-off" title="0" rel="module_' + module_row + '_status"></div><input name="tg_tglite_revolution_slider_module[' + module_row + '][status]" value="0" id="module_' + module_row + '_status" type="hidden" />';
								html += '    </td>';
