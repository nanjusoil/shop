      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
              ...
              &nbsp;<a onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><img src="catalog/view/theme/<?php echo $config->get( 'config_template' ); ?>/image/remove.png" alt="<?php echo $button_remove; ?>"  style="cursor:pointer;" title="<?php echo $button_remove; ?>" /></a>
          </td>
